    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section id="praise" className="bg-cyan-50 py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
          ...
          <div className="rounded-[2rem] border border-cyan-200 bg-white p-8 shadow-sm"><p className="text-lg leading-8 text-slate-700">Brent is the author of <span className="font-bold text-slate-950">PRAISE: The Cornerstone of Coaching to Success</span> and creator of the PRAISE coaching methodology. The approach helps managers prepare for coaching, present feedback clearly, and follow up with specific praise when the right behaviours are demonstrated.</p><a href="https://www.amazon.com/s?k=PRAISE+The+Cornerstone+of+Coaching+to+Success+Brent+Pattison" target="_blank" rel="noopener noreferrer" className="mt-7 inline-flex items-center gap-2 rounded-full bg-slate-950 px-5 py-3 font-bold text-white transition hover:bg-slate-800">View the book <ArrowRight className="h-4 w-4" /></a></div>
        </div>
      </section>
